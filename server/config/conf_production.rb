...
DELIVERY_SITE_TYPES = [
  ...
  {:id => '[F] M1 1C PTB RDR SelfRead Yes', :name => '[F] M1 1C PTB RDR SelfRead Yes', :environments => ['FAT1', 'FAT4', 'DEV4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 100},
  {:id => '[F] M1 1C PTB RDR SelfRead No', :name => '[F] M1 1C PTB RDR SelfRead No', :environments => ['FAT1', 'FAT4', 'DEV4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 100},
  {:id => '[F] M1 1C FULL RDR', :name => '[F] M1 1C FULL RDR', :environments => ['FAT1', 'FAT4', 'DEV4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 100},
  {:id => '[F] M1 2C', :name => '[F] M1 2C', :environments => ['FAT1', 'FAT4', 'DEV4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T7 1C', :name => '[F] T7 1C', :environments => ['FAT1', 'FAT4', 'DEV4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T1 1C MicroProduction', :name => '[F] T1 1C MicroProduction', :environments => ['FAT1', 'FAT4', 'DEV4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T1 1C', :name => '[F] T1 1C', :environments => ['FAT1', 'FAT4', 'DEV4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T1 2C', :name => '[F] T1 2C', :environments => ['FAT1', 'FAT4', 'DEV4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T1 4C', :name => '[F] T1 4C', :environments => ['FAT1', 'FAT4', 'DEV4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
