...
TEST_SUITES = [
  ...
  {:name => '[F] REGRESSION TESTS 11', :type => 'Suite', :environments => ['FAT1', 'FAT4', 'FAT5', 'DEV4'], :piazza => true, :default_number_of_tests => 32, :priority => 112, :project_file => 'Fortum_regression_benkepet.xml'},
