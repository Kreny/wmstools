...
#  {:name => '[F] REGRESSION TESTS GUI 1', :type => 'Suite', :environments => ['FAT1', 'FAT4', 'FAT5'], :piazza => true, :default_number_of_tests => 10, :priority => 111, :project_file => 'Fortum_gui_benkepet.xml'},
  ...
  {:name => '[HE] REGRESSION TESTS 2', :type => 'Suite', :environments => ['DEVHF02', 'DEVHF03'], :piazza => true, :default_number_of_tests => 4, :priority => 380, :project_file => 'Hafslund_elhub_regression_benkepet.xml'},
...
DELIVERY_SITE_TYPES = [
  ...
  {:id => '[F] M1 2C', :name => '[F] M1 2C', :environments => ['FAT1', 'FAT4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T7 1C', :name => '[F] T7 1C', :environments => ['FAT1', 'FAT4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T1 1C MicroProduction', :name => '[F] T1 1C MicroProduction', :environments => ['FAT1', 'FAT4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T1 1C', :name => '[F] T1 1C', :environments => ['FAT1', 'FAT4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T1 2C', :name => '[F] T1 2C', :environments => ['FAT1', 'FAT4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
  {:id => '[F] T1 4C', :name => '[F] T1 4C', :environments => ['FAT1', 'FAT4'], :test_suite_name => '[F] BUFFER TESTS', :quota => 50},
